...
import { createCheckoutController, confirmCheckoutController, getMyPaymentsController, createTopUpController } from "../controllers/payment.controller.js";

const paymentRoutes = express.Router();

paymentRoutes.post('/topup', authCheck, createTopUpController);
